                    ...
                    <div className="mt-8 grid grid-cols-1 gap-6 lg:grid-cols-12">
                        ...
                        {data.tableOfContents && data.tableOfContents.length > 0 && (
                            <aside className="lg:col-span-4">
                                <div className="rounded-xl bg-[#121212] p-4 ring-1 ring-white/10 lg:sticky lg:top-20">
                        ...
                        {/* Content */}
                        <div
                            className={`${data.tableOfContents && data.tableOfContents.length > 0 ? "lg:col-span-8" : "lg:col-span-12"} space-y-5`}
                        >
