        ...
        <main className="min-h-screen bg-black">
            ...
            <section id="home" className="relative isolate">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 md:py-36 min-h-[60vh] sm:min-h-[70vh] flex flex-col justify-center text-white text-center md:text-left" data-animate>
                    ...
                    <h1 className="text-3xl sm:text-5xl md:text-6xl font-extrabold mb-4 wrap-balance" data-tina-field={field(page, 'hero', 'heading')}>
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                        ...
                        <a href="#nasza-firma" className="inline-flex items-center justify-center gap-2 rounded-md ring-1 ring-white/40 px-5 py-3 hover:bg-white/10 transition w-full sm:w-auto">
                            Nasza firma
                        </a>
                    </div>
                </div>
            ...
            <section id="uslugi" className="relative py-12 sm:py-16 lg:py-20 bg-[#0b0b0b] text-white overflow-hidden" data-animate>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center md:text-left">
                    <div className="relative flex items-center justify-center gap-3 sm:gap-4 mb-2">
                        <h2 className="text-3xl sm:text-4xl font-bold text-center" data-tina-field={field(page, 'services', 'heading')}>
            ...
            {/* NOWE PODNOŚNIKI */}
            <section id="nowe-podnosniki" className="py-12 sm:py-16 bg-[#0b0b0b] text-white" data-animate>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-10 items-center">
                    <div className="text-center lg:text-left">
                        ...
                        <h2 className="mt-4 text-3xl font-bold wrap-balance" data-tina-field={field(page, 'lifts', 'heading')}>
                            {content.lifts.heading}
                        </h2>
                        <p className="mt-3 text-white/80 max-w-prose mx-auto md:mx-0" data-tina-field={field(page, 'lifts', 'description')}>
                            {content.lifts.description}
                        </p>
                        <div className="mt-6 flex justify-center md:justify-start">
                            <a href="https://app.autonova.com/pl/c/LjiDS" target="_blank" rel="noopener noreferrer" className="inline-flex items-center rounded-md bg-yellow-400 text-black font-semibold px-5 py-3 hover:bg-yellow-300 transition">
                                Umów wizytę
                            </a>
                        </div>
                    </div>
                    <div className="relative">
                        <div className="aspect-[4/3] w-full overflow-hidden rounded-lg ring-1 ring-white/10 bg-[#0b0b0b]">
                            <LightboxImage src="/podnosnik.avif" fallbackSrc="/podnosnik.png" alt="Podnośnik w warsztacie Bezawaryjni"
                                width={1280} height={720} className="h-full w-full object-contain" priority={false} loading="lazy" />
                        </div>
                    </div>
                </div>
            </section>
            ...
            {/* NASZA FIRMA */}
            <section id="nasza-firma" className="py-16 bg-[#0b0b0b] text-white" data-animate>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-10 items-start">
                    <div className="md:col-span-2 text-center md:text-left">
                        <h2 className="text-3xl sm:text-4xl font-bold wrap-balance" data-tina-field={field(page, 'about', 'heading')}>
            ...
            <section id="kontakt" className="py-16 bg-black text-white" data-animate>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 className="text-3xl sm:text-4xl font-bold wrap-balance text-center" data-tina-field={field(page, 'contact', 'heading')}>
            ...
            {/* FAQ */}
            <section id="faq" className="py-16 bg-[#0b0b0b] text-white" data-animate>
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 className="text-3xl sm:text-4xl font-bold text-center wrap-balance mb-8" data-tina-field={field(page, 'faq', 'heading')}>
                        {content.faq.heading}
                    </h2>
                    <div className="space-y-4">
                        {content.faq.items.map((item, i) => {
                            ...
                            return (
                                <details key={i} className="group rounded-lg bg-gradient-to-b from-[#121212] to-[#0e0e0e] ring-1 ring-white/10 p-4 hover:ring-yellow-400/30 transition-all">
                                    <summary className="cursor-pointer font-semibold text-white/90 list-none flex items-start gap-3">
                                    ...
                                    <p className="mt-3 ml-6 text-white/70" data-tina-field={faqItem ? tinaField(faqItem, 'answer') : undefined}>
                                        {item.answer}
                                    </p>
                                </details>
                            );
...
function ToolsIcon() {
    return (
        <svg viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor" aria-hidden>
            <path d="M21 7.5l-3 3-2-2 3-3a3 3 0 10-4.24-4.24l-1.06 1.06 2.12 2.12-3.54 3.54 1.41 1.41 3.54-3.54 2.12 2.12L14.5 11l1.41 1.41 5.09-5.09a1 1 0 000-1.41zM3.7 14.3l6-6 2 2-6 6-2.7.7.7-2.7z" />
        </svg>
    );
}
...
function ClockIcon() {
    return (
        <svg viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor" aria-hidden>
            <path d="M12 2a10 10 0 1010 10A10.011 10.011 0 0012 2zm1 11h5v-2h-4V7h-2v6z" />
        </svg>
    );
}
...
function CartIcon() {
    return (
        <svg viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor" aria-hidden>
            <path d="M7 18a2 2 0 102 2 2 2 0 00-2-2zm10 0a2 2 0 102 2 2 2 0 00-2-2zM6.2 6l.4 2H21l-1.6 7H8l-.3-1.5h10.5l.3-1.5H7.3L6.1 6H3V4h3.8z" />
        </svg>
    );
}
